...
from tensorflow.python.keras.layers import Input, GRU, Dense, Concatenate, TimeDistributed, Embedding
...
answers = preprocessing.sequence.pad_sequences(decoder_target_data, maxlen=MAX_LENGTH, padding='post')
