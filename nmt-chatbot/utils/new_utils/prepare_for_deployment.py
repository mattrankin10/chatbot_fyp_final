...
paths = ['core', 'model/train_log', 'nmt', 'setup/settings.py', 'setup/answers_replace.txt', 'setup/answers_subsentence_score.txt', 'utils/run_tensorboard.py', 'inference.py', 'requirements.txt', hparams['out_dir'] + 'hparams']
