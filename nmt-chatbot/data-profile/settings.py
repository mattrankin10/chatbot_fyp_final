...
out_dir_name = os.path.join(package_path, "model-profile/")

# Training data path
train_dir = os.path.join(package_path, "data/")

train_dir_profile = os.path.join(package_path, "data-profile/")
...
#    'num_keep_ckpts': 5,
     'src_vocab_file': 'data-profile/vocab.bpe.from',

    ## You don't normally need to change anything below (internal settings)
    'src': 'from',
    'tgt': 'to',
    'vocab_prefix': os.path.join(train_dir_profile, "vocab"),
    'train_prefix': os.path.join(train_dir_profile, "train"),
    'dev_prefix': os.path.join(train_dir_profile, "tst2012"),
    'test_prefix': os.path.join(train_dir_profile, "tst2013"),
